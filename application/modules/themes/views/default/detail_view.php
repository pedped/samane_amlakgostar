...
<?php if ($post->num_rows() <= 0) { ?>
    ...
    <div class="alert alert-danger">کد پستی نا معتبر است</div>
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <?php if (count($images) > 0 && file_exists(('uploads/gallery/' . $images[0]))) : ?>
            ...
            <?php
            $detail_link = site_url('show/detail/' . $row->unique_id . '/' . url_title($estate_title));
            ;
            ?>
            ...
            <div class="" id="panel">
                ...
                <ul class="list-group property-meta-list">
                    ...
                    <li class="list-group-item">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-5 titles"><span><i class="fa fa-arrows-alt "></i> <?php echo$row->home_size ?> متر مربع</span></div>

                            <div class="col-md-3 col-sm-3 col-xs-5 titles"><span><img src="<?php echo theme_url() ?>/assets/images/icons/bedrooms_fa2.png"> <?php echo $row->bedroom; ?> <?php echo lang_key('DBC_BEDROOM'); ?></span></div>

                            <div class="col-md-3 col-sm-3 col-xs-5 titles last"><span><img src="<?php echo theme_url() ?>/assets/images/icons/bathrooms_fa2.png"> <?php echo $row->bath; ?> <?php echo lang_key('DBC_BATH'); ?></span></div>
                    ...
                    <li class="list-group-item">
                        ...
                        <div class="row">
                            ...
                            <?php
                            $rent_price = ($row->rent_price > 0) ? $row->rent_price : 'N/A';
                            $rent_price_unit = ($row->rent_price_unit != '') ? $row->rent_price_unit : 'N/A';
                            ?>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-5 titles"><span><i class="fa fa-ticket"></i> <?php echo lang_key('DBC_STATUS'); ?>: <?php echo lang_key($row->estate_condition); ?></span></div>

                            <div class="col-md-3 col-sm-3 col-xs-5 titles last"><span><i class="fa fa-clock-o"></i> <?php echo lang_key('DBC_YEAR_BUILT'); ?>: <?php echo $row->year_built; ?></span></div>
                ...
                <div class="title"><i class="fa fa-rocket fa-4"></i>&nbsp;<?php echo lang_key('DBC_GA'); ?></div>
            ...
            <div class="panel-body tags-panel">
                <?php
                $tags = get_post_meta($row->id, 'tags');
                $tags = explode(',', $tags);
                foreach ($tags as $tag) {
            ...
            <div class="share-networks clearfix">
                ...
                <div class="col-md-3 col-sm-2 col-xs-12 share-label"><i class="fa fa-share fa-lg"></i> <?php echo lang_key('DBC_SHARE_THIS'); ?>:</div>

                <div class="col-md-2 col-sm-2 col-xs-4 share-option fb"><a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $detail_link; ?>" target="_blank"><i class="fa fa-facebook fa-lg"></i>فیسبوک</a></div>

                <div class="col-md-2 col-sm-2 col-xs-4 share-option twitter"><a href="https://twitter.com/share?url=<?php echo $detail_link; ?>" target="_blank"><i class="fa fa-twitter fa-lg"></i>تویتر</a></div>

                <div class="col-md-2 col-sm-2 col-xs-4 share-option gplus"><a  href="https://plus.google.com/share?url=<?php echo $detail_link; ?>" target="_blank"><i class="fa fa-google-plus fa-lg"></i>گوگل</a></div>

                <div class="col-md-2 col-sm-2 col-xs-4 share-option gplus"><a  href="<?php echo site_url('show/printview/' . $row->unique_id); ?>" target="_blank"><i class="fa fa-print fa-lg"></i>پرینت</a></div>
                            ...
                            <?php if ($row->status == 2) { ?>
                                ...
                                <?php } elseif ($row->purpose == 'DBC_PURPOSE_SALE') { ?>
                                    ...
                                    <?php } else if ($row->purpose == 'DBC_PURPOSE_RENT') { ?>
                                        ...
                                        <!-- XXXX in ghesmat baraye ejare por shavad !-->

                                        <?php
                                        if ($row->purpose == 'DBC_PURPOSE_SALE' || $row->purpose == 'DBC_PURPOSE_BOTH') {
                                            ?>
                                            <div class="info_list">
                                                <span class="info-title" style="">قیمت فروش:</span>
                                                <span class="info-content"><?php echo show_price($row->total_price); ?></span>
                                            </div>
                                        ...
                                        if ($row->purpose == 'DBC_PURPOSE_RENT' || $row->purpose == 'DBC_PURPOSE_BOTH') {
                                            ?>
                                            <div class="info_list">
                                                <span class="info-title" style="">قیمت رهن:</span>
                                                <span class="info-content"><?php echo show_price($row->rent_pricerahn); ?></span>
                                            </div>
                                            <div class="divider"></div>

                                            <div class="info_list">
                                                <span class="info-title" style="">قیمت اجاره:</span>
                                                <span class="info-content"><?php echo show_price($row->rent_price); ?></span>
                                            </div>
                                            <?php
                                        }
                                        ?>
                                        ...
                                        <div class="info_list">
                                            ...
                                            <span class="info-title" style="">تاریخ:</span>

                                            <span class="info-content"><?= getestatedate($row->adddate); ?></span>
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="agent clearfix">
                                                    ...
                                                    <div class="email"><a href="mailto:<?php echo get_user_email_by_id($row->created_by); ?>"><?php echo get_user_email_by_id($row->created_by); ?></a>
                                                        ...
                                                        <div class="agent-properties"><a href="<?php echo site_url('show/agentproperties/' . $row->created_by); ?>"><?php echo get_user_properties_count($row->created_by); ?> املاک</a></div>
