...
<?php if ($post->num_rows() <= 0) { ?>
    ...
    <div class="alert alert-danger">کد پستی نامعتبر است</div>
...
<?php
    ...
    ; ?>
            ...
            <div class="share-networks clearfix">
                ...
                <div class="col-md-2 col-sm-2 col-xs-4 share-option twitter"><a href="https://twitter.com/share?url=<?php echo $detail_link; ?>" target="_blank"><i class="fa fa-twitter fa-lg"></i>توییتر</a></div>
                ...
                <div class="col-md-2 col-sm-2 col-xs-4 share-option gplus"><a  href="javascript:window.print()"><i class="fa fa-print fa-lg"></i>پرینت</a></div>
    ...
    <?php $rent_price = ($row->rent_price > 0) ? $row->rent_price : 'N/A';
    $rent_price_unit = ($row->rent_price_unit != '') ? $row->rent_price_unit : 'N/A'; ?>

                            <div class="col-md-3 col-sm-3 col-xs-5 titles"><span><i class="fa fa-money"></i> <?php show_price($row->total_price); ?><?php echo ($row->purpose == 'DBC_PURPOSE_RENT') ? lang_key($row->rent_price_unit) : ''; ?></span></div>
    ...
    <!--                    <input type="text" name="from_route" placeholder="آدرس خود را وارد نمایید" value="" class="form-control input-sm col-md-4" style="width: 33.3333%" id="from_route">-->

                    <!--                    <div style="float: left" class="btn-group btn-group-sm"><a id="route_from_button" class="btn btn-warning btn-sm" href="javascript:void(0)" >مشاهده مسیر</a></div>-->
    ...
    <?php } ?>
                                        ...
                                        <div class="property-thumb-meta">
                                            ...
                                            <span class="property-price">میلیون تومان <?php echo $row->total_price; ?></span>
                                        ...
                                        <div class="detail-title no-print"><i class="fa fa-envelope-o"></i>&nbsp;<?php echo lang_key('DBC_MESSAGE'); ?></div>
