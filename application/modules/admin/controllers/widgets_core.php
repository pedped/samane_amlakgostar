...
class Widgets_core extends CI_Controller {
	...
	public function savewidgetpositions()
	{
		...
		$this->session->set_flashdata('msg','<div class="alert alert-info">موقعیت افزونه به روز گردید.</div>');
	...
	public function savewidget()
	{
		...
		{
		     $this->session->set_flashdata('msg', '<div class="alert alert-error">ساخت فایل گجت ناموفق بود</div>');
		}
		else
		{
		     $this->session->set_flashdata('msg', '<div class="alert alert-success">Widget اطلاعات ذخیره گردید</div>');
		}
	...
	public function setstatus($alias='',$status=1)
	{
		...
		$this->session->set_flashdata('msg','<div class="alert alert-info">تنظیمات به روز گردید</div>');
	...
	public function create()
	{
		...
		else
		{
			...
			$this->session->set_flashdata('msg','<div class="alert alert-info">گجت اضافه گردید.</div>');
			redirect(site_url('admin/widgets/all'));
		}
	}
