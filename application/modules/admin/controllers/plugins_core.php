...
class Plugins_core extends CI_Controller {
    ...
    public function enable($id = '') {
        ...
        $this->session->set_flashdata('msg', '<div class="alert alert-info">پلاگین به روز گردید</div>');
    ...
    public function disable($id = '') {
        ...
        $this->session->set_flashdata('msg', '<div class="alert alert-info">پلاگین بسته گردید</div>');
        redirect(site_url('admin/plugins/all'));
    }
