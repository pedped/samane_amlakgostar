  ...
  <body>
    ...
    <div class="container">
      ...
      <form action="<?php echo site_url('admin/auth/signup/');?>" method="post" class="form-signin">
        <h2 class="form-signin-heading">ساخت حساب</h2>
        <input type="text" class="input-block-level" placeholder="نام کاربری" name="username">
        <input type="text" class="input-block-level" placeholder="ایمیل" name="useremail">
        <input type="password" class="input-block-level" placeholder="رمز عبور" name="password">
        <input type="password" class="input-block-level" placeholder="تکرار مجدد رمز عبور" name="repassword">
        <label class="checkbox">
          <input type="checkbox" value="remember-me" name="remember"> مرا به خاطر بسپار
        </label>
        <button class="btn btn-large btn-primary" type="submit">عضویت</button>
        <a href="#">فراموشی رمز عبور</a><a style="margin-left:10px;" href="<?php echo site_url('admin');?>">ورود</a>
