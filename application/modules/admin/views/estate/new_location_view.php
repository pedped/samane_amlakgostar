...
<label>یک کشور را انتخاب نمایید</label>
<select name="country" class="form-control country-<?php echo $type;?>">
	<option value="">یک کشور را انتخاب نمایید</option>
	<?php 
...
<?php if($type=="city"){?>
<label>یک استان را انتخاب نمایید</label>
<select name="state" class="form-control state-drop">
	<option value=""> یک استان را انتخاب نمایید</option>
	<?php 
...
<label><?php echo $type;?> نام ها :</label>
<textarea class="form-control" style="height:260px;" name="locations" ></textarea>
<div class="alert alert-info">نام های بیشتری انتخاب نمایید</div>
