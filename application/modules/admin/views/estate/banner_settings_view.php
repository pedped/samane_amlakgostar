    ...
    <div class="col-md-12">
        ...
        <form class="form-horizontal" id="addpackage" action="<?php echo site_url('admin/realestate/savebannersettings'); ?>" method="post">
            ...
            <div class="box">
                ...
                <div class="box-title">
                    <h3><i class="fa fa-bars"></i>تنظیمات بنر</h3>
                    <div class="box-tool">
                ...
                <div class="box-content">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-2 control-label">پیش زمینه منو:</label>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-2 control-label">متن رنگ منو:</label>
                        <div class="col-sm-5 col-lg-3 controls">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-2 control-label">نوع بنر:</label>
                        <div class="col-sm-4 col-lg-5 controls">
                            <?php $options = array("Slider", "Google Map" , "Nothing"); ?>
                    ...
                    <div id="slider-panel" style="display:none">
                        <h4 style="margin-left:30px;border-bottom:1px solid #ccc;padding-bottom:10px;">تنظیمات اسلاید</h4>
                        <div class="form-group">
                            <label class="col-sm-3 col-lg-2 control-label">سرعت اسلاید:</label>
                            <div class="col-sm-4 col-lg-5 controls">
                                <?php
                                $options = array("1000" => "1 sec", "2000" => "2 sec", "3000" => "3 sec",
            ...
            <div class="box">
                ...
                <div class="box-title">
                    <h3><i class="fa fa-bars"></i>تنظیمات نقشه</h3>
                    <div class="box-tool">
                        <a href="#" data-action="collapse"><i class="fa fa-chevron-up"></i></a>
                    </div>
                </div>
                <div class="box-content">
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-2 control-label">عرض جغرافیایی:</label>
                        <div class="col-sm-4 col-lg-5 controls">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-2 control-label">طول جغرافیایی:</label>
                        <div class="col-sm-4 col-lg-5 controls">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-2 control-label">زوم نقشه:</label>
                        <div class="col-sm-4 col-lg-5 controls">
...
<?php } ?>
        ...
        <!--                    <input class="form-control" type="text" name="map_zoom" id="map_zoom" value="--><?php //echo $v;  ?><!--">-->
            ...
            <div class="box">
                ...
                <div class="box-title">
                    <h3><i class="fa fa-bars"></i>تنظیمات پنل جستجو</h3>
                    <div class="box-tool">
                        <a href="#" data-action="collapse"><i class="fa fa-chevron-up"></i></a>
                    </div>
                </div>
                ...
                <div class="box-content">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-2 control-label">موقعیت پنل جستجو :</label>
                        <div class="col-sm-4 col-lg-5 controls">
...
<?php $featured_img = (set_value('search_bg') != '') ? set_value('search_bg') : get_settings('banner_settings', 'search_bg', 'skyline.jpg'); ?>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-2 control-label">تصویر پیش زمینه:</label>
                        <div class="col-sm-4 col-lg-5 controls">                    
