            ...
            <div class="box-content">
                ...
                <form class="form-horizontal" action="<?php echo site_url('admin/realestate/savepaypalsettings/');?>" method="post">
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-2 control-label"><?php echo lang_key('Soandbox '); ?></label>
                    ...
                    <div class="form-group" id="item_name">
                        <label class="col-sm-3 col-lg-2 control-label"><?php echo lang_key('نام سیستم'); ?></label>

                        <div class="col-sm-9 col-lg-10 controls">
                            <input type="text" name="item_name" value="<?php echo(isset($settings->item_name))?$settings->item_name:'';?>" placeholder="چیزی تایپ کنید" class="form-control" >
                    ...
                    <div class="form-group" id="email">
                        <label class="col-sm-3 col-lg-2 control-label"><?php echo lang_key('تنظیمات پیپال'); ?></label>

                        <div class="col-sm-9 col-lg-10 controls">
                            <input type="text" name="email" value="<?php echo(isset($settings->email))?$settings->email:'';?>" placeholder="چیزی تایپ کنید" class="form-control" >
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-2 control-label"><?php echo lang_key('واحد'); ?></label>
                    ...
                    <div class="form-group" id="finish_url">
                        <label class="col-sm-3 col-lg-2 control-label"><?php echo lang_key('لینک پایانی'); ?></label>

                        <div class="col-sm-9 col-lg-10 controls">
                            <input type="text" name="finish_url" value="<?php echo(isset($settings->finish_url))?$settings->finish_url:'';?>" placeholder="چیزی تایپ کنید" class="form-control" >
                    ...
                    <div class="form-group" id="cancel_url">
                        <label class="col-sm-3 col-lg-2 control-label"><?php echo lang_key('لینک کنسل'); ?></label>

                        <div class="col-sm-9 col-lg-10 controls">
                            <input type="text" name="cancel_url" value="<?php echo(isset($settings->cancel_url))?$settings->cancel_url:'';?>" placeholder="چیزی تایپ کنید" class="form-control" >
