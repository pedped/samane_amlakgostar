    ...
    <div class="col-md-12">
        ...
        <div class="box">
            ...
            <div class="box-title">
                ...
                <h3><i class="fa fa-bars"></i> تمامی پست های فعال</h3>
                        ...
                        <table class="table table-hover">
                            ...
                            foreach ($posts->result() as $row): 
                                ...
                                <tr>
                                    ...
                                    <td data-title="Email" class="numeric"><?php echo ($row->featured==1)?'<div class="alert alert-success" style="margin-top:5px;">ویژه</div>':'<div class="alert alert-info" style="margin-top:5px;">غیر ویژه</div>';?></td>
                                    ...
                                    <td data-title="Options" class="numeric">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown-info">
                                                ...
                                                <!--li><a href="<?php echo site_url('admin/memento/approvepost/'.$page.'/activeposts/'.$row->id); ?>">پذیرفتن</a-->

                                                <li><a href="<?php echo site_url('admin/memento/deletepost/'.$page.'/activeposts/'.$row->id); ?>">حذف</a>
                                                <?php if($row->featured==0){?>
                                                <li><a href="<?php echo site_url('admin/memento/featurepost/'.$page.'/activeposts/'.$row->id); ?>">ویژه</a>
                                                <?php }else{?>
