    ...
    <div class="col-md-12">
        ...
        <div class="box">
            ...
            <div class="box-title">
                ...
                <h3><i class="fa fa-bars"></i> تمامی پست های گزارش شده</h3>
                                    ...
                                    <td data-title="Options" class="numeric">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown-info">
                                                ...
                                                <li><a href="<?php echo site_url('admin/memento/approvepost/'.$page.'/allreported/'.$row->id); ?>">پذیرفتن</a>

                                                <li><a href="<?php echo site_url('admin/memento/deletepost/'.$page.'/allreported/'.$row->id); ?>">حذف</a>
