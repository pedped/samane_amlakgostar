    ...
    <div class="box">
      ...
      <div class="box-content">
		...
		<div class="form-group">
			<label class="col-sm-1 col-lg-1 control-label">تیتر منو</label>
			<div class="col-sm-2 col-lg-3 controls">
				<input type="text" class="form-control" name="title" value="<?php echo $title;?>" placeholder="چیزی تایپ کنید" />
		...
		?>
		<div class="form-group">
			<label class="col-sm-1 col-lg-1 control-label">لایه منو</label>
			<div class="col-sm-2 col-lg-3 controls">
