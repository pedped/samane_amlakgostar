	...
	<div class="col-md-12">
		...
		<div class="box">
			...
			<div class="box-content">
				...
				<!--a id="edit_as_new_lang" href="<?php echo site_url('admin/system/editasnewlang/'.$row->id);?>" class="btn btn-info">افرودن به عنوان جدید</a-->
...

{
	...
	echo '<div class="alert alert-info input-xxlarge" style="margin-top:20px;">فایل زبان را انتخاب نمایید و بر روی کلید ویرایش ضربه بزنید</div>';
	...
	<div class="col-md-12">
		...
		<div class="box">
			...
			<div class="box-title">
				...
				<h3><i class="fa fa-bars"></i> ویرایش زبان</h3>
			...
			<div class="box-content">
				...
				<form action="<?php echo site_url('admin/system/updatelang');?>" method="post">
					...
					<label><b>زبان :</b> 
						...
						<?php echo (isset($row->lang))?$row->lang:set_value('lang');?>, <b>نام کوتاه :</b> <?php echo (isset($row->short_name))?$row->short_name:set_value('short_name');?></label> 
