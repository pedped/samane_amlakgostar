  ...
  <div class="col-md-12">
    ...
    <div class="box">
      ...
      <div class="box-title">
        ...
        <h3><i class="fa fa-bars"></i> ویرایش صفحه</h3>
      ...
      <div class="box-content">
		...
		<div class="form-group">
			...
			<label class="col-sm2 col-lg-2 control-label">تیتر منو</label>

			<div class="col-sm-5 col-lg-6 controls">

				<input type="text" class="form-control" name="title" id="title" value="<?php echo $title;?>" placeholder="چیزی تایپ کنید" />
		...
		<div class="form-group">
			...
			<label class="col-sm-2 col-md-2 col-lg-2 control-label">نام مستعار منو</label>

			<div class="col-sm-2 col-lg-3 controls">

				<input type="text" class="form-control" name="alias" id="alias" value="<?php echo $alias;?>" placeholder="چیزی تایپ کنید" />
		...
		<div class="form-group">
			...
			<label class="col-sm-2 col-md-2 col-lg-2 control-label">نمایش در منو</label>
		...
		<div class="form-group">
			...
			<label class="col-sm-2 col-md-2 col-lg-2 control-label">لایه صفحه</label>
		...
		<div class="form-group">
			...
			<label class="col-sm-2 col-md-2 col-lg-2 control-label">محتوا از</label>
		...
		<div class="form-group url">
			...
			<label class="col-sm-2 col-md-2 col-lg-2 control-label">آدرس URL</label>

			<div class="col-sm-5 col-lg-6 controls">

				<input type="text" class="form-control" name="url" value="<?php echo $url;?>" placeholder="چیزی تایپ کنید" <?php echo (isset($page->editable) && $page->editable==0)?'readonly="readonly"':'';?> />
    ...
    <div class="box">
      ...
      <div class="box-title">
        ...
        <h3><i class="fa fa-bars"></i> تنظیمات سئو</h3>
      ...
      <div class="box-content">
	      	...
	      	<div class="form-group">
				...
				<label class="col-sm-2 col-md-2 col-lg-2 control-label">توضیحات متادیتا:</label>
			...
			<div class="form-group">
				...
				<label class="col-sm-2 col-md-2 col-lg-2 control-label">کلمات:</label>
