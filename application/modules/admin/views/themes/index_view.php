...
<div class="row">
  <div class="col-md-12">
    <div class="box">
      <div class="box-title">
        <h3><i class="fa fa-bars"></i> پوسته فعال</h3>
        <div class="box-tool">
...
<div class="row">
  <div class="col-md-12">
    <div class="box">
      <div class="box-title">
        <h3><i class="fa fa-bars"></i> پوسته های موجود</h3>
        <div class="box-tool">
          <a href="#" data-action="collapse"><i class="fa fa-chevron-up"></i></a>
          ...
          ?>
              <div class="col-xs-6 col-md-4" style="margin-bottom:30px;">
                ...
                <form action="<?php echo site_url('admin/themes/activate');?>" method="post">
                  ...
                  <button class="btn btn-primary" type="submit"><i class="fa fa-check"></i> فعال سازی</button>
                </form> 
              </div>
         <?php
          }
