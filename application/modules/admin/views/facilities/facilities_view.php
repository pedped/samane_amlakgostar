    ...
    <div class="col-md-12">
        ...
        <div class="box">
            ...
            <div class="box-title">
                ...
                <h3><i class="fa fa-bars"></i>تمامی امکانات</h3>
            ...
            <div class="box-content">
                ...
                <a class="btn btn-primary" style="margin-bottom:15px;" href="<?php echo site_url('admin/realestate/newfacility'); ?>">ساخت یک امکان جدید</a>

                <?php $this->load->helper('text'); ?>

                <?php if ($facilities->num_rows() <= 0) { ?>

                    <div class="alert alert-info">بدون امکانات</div>
                ...
                <form action="" method="post" id="all_facilities_form">
                                    ...
                                    <td data-title="Action" class="numeric">
                                        <div class="btn-group">
                                          ...
                                          <ul class="dropdown-menu dropdown-info">
                                              <li><a href="<?php echo site_url('admin/realestate/edit_facility/'.$row->id);?>">ویرایش</a></li>
                                              <li><a href="<?php echo site_url('admin/realestate/remove_facility/'.$row->id); ?>">حذف</a></li>
                                          </ul>
                                        </div>
                                    </td>
                    ...
                    <a href="#" id="remove-selected" class="btn btn-danger">حذف موارد انتخابی</a>
