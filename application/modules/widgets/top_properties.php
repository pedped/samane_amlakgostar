...
?>
            <div class="widget">
                ...
                <div class="recent-grid"><i class="fa fa-home"></i>&nbsp;<?php echo lang_key('DBC_TOP_PROPERTIES');?></div>
        ...
        <div class="view-more"><a class="" href="<?php echo site_url('show/properties/top');?>"><?php echo lang_key('DBC_VIEW_ALL');?></a></div>
        <div class="clearfix"></div>
<?php } ?>