...
if($topusers->num_rows() <= 0 ){ ?>
    <div class="alert alert-info">هیج هاملی یافت نگردید</div>
<?php
} else {
?>
...
<div class="view-more"><a class="" href="<?php echo site_url('show/agent');?>"><?php echo lang_key('DBC_VIEW_ALL');?></a></div>
