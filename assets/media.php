<div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-header" style="padding: 0 15px;">
        ...
        <h6 id="myModalLabel">مدیریت مدیا</h6>
    </div>
    <div class="modal-body">
        <ul class="nav nav-tabs" id="myTab">
            <li class="active"><a href="#upload" data-toggle="tab">ارسال</a></li>
        ...
        <div class="tab-conten" id="myTabConten" style="min-height:300px;">
            <div id="upload" class="tab-pane fade in active">
                ...
                <div id="preview_panel">
                    ...
                    <button class="btn primary useimg" style="display:none;">استفاده از این</button>
                </div>				
            </div>
    ...
    <div class="modal-footer">
        <!--	<button class="btn" data-dismiss="modal" aria-hidden="true">بسته</button>-->
